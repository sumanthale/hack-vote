    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col items-center space-y-2">
          <h3 className="text-2xl font-extrabold bg-gradient-to-r from-cyan-600 to-blue-700 bg-clip-text text-transparent drop-shadow-sm">
            Scan Here to Vote!
          </h3>
        ...
        {/* QR Image */}
        <div className="bg-white p-2 rounded-3xl border-4 border-cyan-500 inline-block shadow-xl hover:scale-105 transition-transform duration-300">
          <img
            src={qrCode}
